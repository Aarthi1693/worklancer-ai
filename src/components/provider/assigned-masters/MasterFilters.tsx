    ...
    <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="relative w-full lg:max-w-xl">
          ...
          <input
            type="text"
            placeholder="Search by master name or skill..."
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <button className="flex items-center gap-2 rounded-xl border border-slate-300 bg-white px-4 py-2.5 text-slate-600 transition hover:border-blue-300 hover:text-blue-600">
